        ...
        <td align="center" valign="top"><table class="tableMoldura" id="filtro_pesquisa" width="98%">
           ...
           <tr>
            ...
            <tr>
              ...
              <td colspan="3">
			    <input id="sti_demanda_atraso" type="checkbox" value="1" <?php if($vFormPesquisaData['sti_demanda_atraso'] == '1'){echo 'CHECKED';}?> name="sti_demanda_atraso">
			  </td>
            </tr>
      ...
      <tr>
        <td align="center" valign="top"><table class="tableMoldura" id="filtro_pesquisa2" width="98%">
            ...
            <tr class="tableTituloColunas">
              ...
              <td align="left" width="12%"><h3>Responsavel Fluxo</h3></td>
