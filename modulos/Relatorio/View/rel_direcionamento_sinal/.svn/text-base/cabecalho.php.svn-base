...
<script type="text/javascript" src="modulos/web/js/rel_produtos_solicitados_distribuicao.js"></script>
<style type="text/css">
    .laranja {
        color: orange;
        font-weight: bold;
...
<div class="modulo_titulo">Relatorio de Direcionamento de Sinal</div>
