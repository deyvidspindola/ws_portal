...
<?php require_once _MODULEDIR_ . "Relatorio/View/rel_descontos_conceder/cabecalho.php"; ?>
    ...
    <input type="hidden" id="cfooid" name="cfooid" value="<?php echo $this->view->parametros->cfooid; ?>"/>
    
    
    <?php require_once _MODULEDIR_ . "Relatorio/View/rel_descontos_conceder/formulario_cadastro.php"; ?>
