...
<link type="text/css" rel="stylesheet" href="modulos/web/css/rel_envio_reset_equipamento.css" />
...
<script type="text/javascript" src="modulos/web/js/rel_envio_reset_equipamento.js"></script>



<div class="modulo_titulo">Relatório Envio de Reset para Equipamentos</div>
