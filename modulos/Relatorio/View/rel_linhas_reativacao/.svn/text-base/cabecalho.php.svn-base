...
<link type="text/css" rel="stylesheet" href="modulos/web/css/rel_linhas_reativacao.css" />
...
<script type="text/javascript" src="modulos/web/js/rel_linhas_reativacao.js"></script>



<div class="modulo_titulo">Relatório de Linhas para Reativação</div>
