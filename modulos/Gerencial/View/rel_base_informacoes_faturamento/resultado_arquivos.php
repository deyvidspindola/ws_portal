               ...
               $caminho = $control->RetornaCaminhoServidor();
				...
				?>
						...
						echo	date ("d/m/Y H:i:s.", filectime($caminho.$infFile['basename']));	
		           		...
		           		<IMG class="icone" alt="Cancelar" src="<?= _PROTOCOLO_ . _SITEURL_ ?>images/icon_error.png"></a>
		           		<a title="Downloads" target="_blank" href="download.php?arquivo=<?php echo $caminho.$key['nome']; ?>">
		           		<IMG class="icone" alt="Editar" src="<?= _PROTOCOLO_ . _SITEURL_ ?>images/download.png"></a>
					...
					<?php 
						...
						echo	date ("d/m/Y H:i:s.", filectime($caminho.$infFile['basename']));	
		           		...
		           		<IMG  title="Excluir" class="icone" alt="Cancelar" src="<?= _PROTOCOLO_ . _SITEURL_ ?>images/icon_error.png"></a>
		           		<a  target="_blank" href="download.php?arquivo=<?php echo $caminho.$key['nome']; ?>">
		           		<IMG title="Download" class="icone" alt="Editar" src="<?= _PROTOCOLO_ . _SITEURL_ ?>images/download.png"></a>
