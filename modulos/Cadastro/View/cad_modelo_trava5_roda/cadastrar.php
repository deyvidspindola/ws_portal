...
<?php require_once _MODULEDIR_ . "Cadastro/View/cad_modelo_trava5_roda/cabecalho.php"; ?>
    ...
    <input type="hidden" id="tmooid" name="tmooid" value="<?php echo $this->view->parametros->tmooid; ?>"/>
    
    
    <?php require_once _MODULEDIR_ . "Cadastro/View/cad_modelo_trava5_roda/formulario_cadastro.php"; ?>
