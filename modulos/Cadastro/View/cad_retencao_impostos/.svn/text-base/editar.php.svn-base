...
<?php require_once _MODULEDIR_ . "Cadastro/View/cad_retencao_impostos/cabecalho.php"; ?>
    ...
    <form id="form_cadastrar"  method="post" action="cad_retencao_impostos.php">
    <input type="hidden" id="acao" name="acao" value="cadastrar"/>
    <input type="hidden" id="prsrioid" name="prsrioid" value="<?php echo isset($this->view->parametros->prsrioid) ? $this->view->parametros->prsrioid : '' ?>"/>
