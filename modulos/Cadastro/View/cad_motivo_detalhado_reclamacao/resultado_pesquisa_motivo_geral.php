...
<div class="separador"></div>
	...
	<div class="resultado bloco_titulo">Motivos Detalhados:</div>
		            ...
		            <tbody>
		                ...
		                if (count($this->view->dados) > 0): ?>
		                    ...
		                    <?php foreach ($this->view->dados as $resultado) : ?>
		                            ...
		                            $primeiraLetra = strtoupper(substr($resultado->mdrdescricao,0,1));
		                          
		                            if($primeiraLetra != $primeiraLetraAnterior){
		                                                    
		                                $primeiraLetraAnterior = strtoupper(substr($resultado->mdrdescricao,0,1));
		                            ...
		                            <td>
		                                <input class="checkResultado checkbox_<?php echo $resultado->mdroid?>" id="<?php echo $resultado->mdroid?>" type="checkbox" value="" name="checkbox_<?php echo $resultado->mdroid?>" <?php echo ($resultado->mrmdstatus == 't') ? 'checked' : '' ?>>
		                                <?=ucwords(strtolower(($resultado->mdrdescricao)));?>
		                            </td>
