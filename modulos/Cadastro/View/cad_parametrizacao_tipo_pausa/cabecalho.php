...
<script type="text/javascript" src="modulos/web/js/cad_parametrizacao_tipo_pausa.js"></script>


<div class="modulo_titulo">Horários de Pausa</div>
<div class="modulo_conteudo">
    <ul class="bloco_opcoes">
        <li><a href="cad_horario_pausa_item.php" title="Lançamento de Pausa">Lançamento de Pausa</a></li>
        <li><a href="cad_grupo_trabalho.php" title="Perfil de Acesso">Perfil de Acesso</a></li>
        <li class="ativo"><a href="cad_parametrizacao_tipo_pausa.php" title="Tipo de Pausa">Tipo de Pausa</a></li>
    </ul>
    <div class="bloco_titulo">Parametrização de Pausas</div>
