...
<link type="text/css" rel="stylesheet" href="modulos/web/css/cad_acao_os.css" />
...
<script type="text/javascript" src="modulos/web/js/cad_acao_os.js"></script>


<div class="modulo_titulo">Cadastro de Ações para OS</div>
