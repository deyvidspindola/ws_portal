	...
	<div class="bloco_conteudo">
		<div class="conteudo">
			<div class="campo maior">
				...
				<input type="text" id="emeeqpdescricao" name="emeeqpdescricao" value="<?=$resultado['emeeqpdescricao']?>" class="campo" onblur="jQuery(this).val(jQuery.trim(jQuery(this).val()));"/>
			</div>
