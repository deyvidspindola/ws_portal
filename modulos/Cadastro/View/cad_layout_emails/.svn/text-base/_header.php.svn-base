...
<head>            
    ...
    <link type="text/css" rel="stylesheet" href="modulos/web/css/cad_layout_emails.css">
    ...
    <script type="text/javascript" src="modulos/web/js/cad_layout_emails.js"></script>    
</head>