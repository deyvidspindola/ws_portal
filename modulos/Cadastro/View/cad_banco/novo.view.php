 ...
 */
    ...
    $tecoid = ($_POST['tecoid'])?$_POST['tecoid']:0;
...
<tr>
    <td align="center">
        <form name="novoBanco" id="novoBanco" method="post" action="">
            ...
            <table class="tableMoldura dados_pesquisa">
                ...
                <tr>
                    ...
                    <td>
                        <input name="cfbbanco" id="cfbbanco" style="width: 75px;" maxlength="6" />
                    </td>
                </tr>
                <tr>
                    <td><label for="cfbtecoid">Empresa: *</label></td>
                    <td>
                        <select name="cfbtecoid" id="cfbtecoid" onchange="pesquisaContaContabil(jQuery(this).val());">
                            <option value="0">Selecione</option>
                            <?php
                                foreach($arrEmpresas as $empresa) {
                                    $sel = ($tecoid > 0 && $tecoid == $empresa['tecoid'])?"selected='selected'":"";
                ...
                <tr>
                    ...
                    <td>
                        <input name="cfbnome" id="cfbnome" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
                    <td><label for="cfbconvenio">Convênio:</label></td>
                    <td>
                        <input name="cfbconvenio" id="cfbconvenio" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
                    <td><label for="cfblimite">Limite:</label></td>
                    <td>
                        <input name="cfblimite" id="cfblimite" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select name="cfbplcoid" id="cfbplcoid">
                            ...
                            <?php if($tecoid > 0) {
                                ...
                                foreach($arrPlanoContabil['planos'] as $plc) {
                                    if($plc['plctecoid'] == $tecoid) {
                                        print '<option value="'.$plc['plcoid'].'">'.$plc['plcdescricao'].'</option>';
                                    }
                                }
                ...
                <tr>
                    ...
                    <td>
                        <input name="cfbagencia" id="cfbagencia" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
                    <td><label for="cfbconta_corrente">Conta: *</label></td>
                    <td>
                        <input name="cfbconta_corrente" id="cfbconta_corrente" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
                    <td><label for="cfbagencia_convenio">Agência Convênio:</label></td>
                    <td>
                        <input name="cfbagencia_convenio" id="cfbagencia_convenio" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
                    <td><label for="cfbconta_corrente_convenio">Conta Corrente Convênio:</label></td>
                    <td>
                        <input name="cfbconta_corrente_convenio" id="cfbconta_corrente_convenio" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="cfbfluxo" id="cfbfluxo" value="true" />
                    </td>
                </tr>
                <tr>
                ...
                <tr class="tableRodapeModelo1" style="height:23px;">
                    <td align="center" colspan="4">
                        <input type="button" name="bt_salvar" id="bt_salvar" value="Salvar" class="botao" onclick="jQuery('#novoBanco').submit();" style="width:70px;">
