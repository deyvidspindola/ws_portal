...
<form id="form"  method="post" action="cad_acao_motivo.php">
    <input type="hidden" id="acao" name="acao" value="pesquisar"/>
    <input type="hidden" id="motivo_id" name="motivo_id" value=""/>
    <input type="hidden" id="acao_id" name="acao_id" value=""/>


    <?php require_once _MODULEDIR_ . "Cadastro/View/cad_acao_motivo/formulario_pesquisa.php"; ?>
