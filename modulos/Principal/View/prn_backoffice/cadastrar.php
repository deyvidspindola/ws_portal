...
<?php require_once _MODULEDIR_ . "Principal/View/prn_backoffice/cabecalho.php"; ?>
    ...
    <form id="form_cadastrar"  method="post" action="prn_backoffice.php">
        <input type="hidden" id="acao" name="acao" value="cadastrar"/>
        <input type="hidden" id="bacoid" name="bacoid" value="<?php echo $this->view->parametros->bacoid; ?>"/>
       
    
    <?php require_once _MODULEDIR_ . "Principal/View/prn_backoffice/formulario_cadastro.php"; ?>
