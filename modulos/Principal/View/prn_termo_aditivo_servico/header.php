...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="modulos/web/css/prn_termo_aditivo_servico.css"/>
    ...
    <script type="text/javascript" src="modulos/web/js/prn_termo_aditivo_servico_validacoes.js"></script> 
    <script type="text/javascript" src="modulos/web/js/prn_termo_aditivo_servico.js"></script>
</head>