<html>
	...
	<body>
		<table border="0" width="720">
			<tr>
				<td>
					<img src="<?php echo _PROTOCOLO_;?><?php echo _SITEURL_?>images/logo_sascar_nova.jpg" width="200"/>
				</td>
				<td>
					&nbsp;
				</td>
			...
			<tr>
				<td colspan="2">
					...
					A SASCAR informa ter identificado em seu sistema falta de comunicação do equipamento, para o(s) veículo(s) abaixo identificado(s):
					<br />
