...
class UraAtivaAssistenciaDAO extends UraAtivaDAO {
	...
	/**
	 * Busca por número de OS, os contatos de OSs que necessitam de atendimento
	...
	public function descartar(UraAtivaContratoVO $contrato) {
		...
		if ($retorno == 1) {
			...
			$this->motivoLog = "Descartado por itens O.S. diferente de Assistência";
    ...
    /**
     * Descarta a OS pela parametrização: O.S. agendada com data posterior a data atual
     *
     * @param int $ordoid
     * @return boolean
     */
