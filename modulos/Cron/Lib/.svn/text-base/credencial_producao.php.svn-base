...
//  	);
//	// Alterado para o DNS - GMUD 6570
//	$client = new SoapClient("http://cordilheira.sascar.com.br/Service/EBS.IntegracaoFoxService.IntegracaoFoxService.svc?wsdl", $params);
//	
