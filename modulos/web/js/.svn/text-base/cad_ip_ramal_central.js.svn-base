jQuery(document).ready(function(){
    ...
    jQuery("table").on('click','.editar',function(event) {
        ...
        window.location.href = "cad_ip_ramal_central.php?acao=editar&oid="+id;
    });
   
    //botão novo
    jQuery("#bt_novo").click(function(){
        window.location.href = "cad_ip_ramal_central.php?acao=cadastrar";
    });
   
    //botão voltar
    jQuery("#bt_voltar").click(function(){
        window.location.href = "cad_ip_ramal_central.php";
    })
