        ...
        return this.each(function() {
          ...
          var upload_file = function()
          {
            ...
            if(true === settings.validate_extensions && $.inArray(ext, settings.valid_extensions) == -1)
            {
              ...
              settings.onComplete.apply($element, [{status: false, message: 'Somente são aceitas imagens dos tipos ' + settings.valid_extensions.join(', ') + '.'}, settings.params]);
            } else
            { 
              uploading_file = true;
          ...
          */
          var wrapElement = function(element) {
            ...
            $('body').after('<iframe width="0" height="0" style="display:none;height:0" name="'+frame_id+'" id="'+frame_id+'"/>');
