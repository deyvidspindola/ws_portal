                ...
                try{
                	...
                	if(teste != null){
	                    ...
	                    switch(codigo[5]){
	                    	...
	                    	case '001': 
	                    		mensagem = "Erro ao pesquisar registro!";
		                    	break;
	                    
	                        case '002' :
	                        	mensagem = 'Já existe um motivo cadastrado com essa descrição.';
	                            break;
                    ...
                    jQuery("#div_msg_pesquisar").html(mensagem);
    ...
    */
    ...
    jQuery('#bt_cadastrar').click(function(){
        ...
        if(jQuery.trim(jQuery('#descricao_cadastro').val()).length == 0){
            criaAlerta('Favor preencher o campo obrigatório.');
            ...
            success: function(data){
                ...
                try{
                    ...
                    if(resultado.error){
                        ...
                        pesquisar(resultado.id);
                        
                        jQuery('#div_msg_pesquisar').html('Registro Incluído!');
                        jQuery('#div_msg_pesquisar').show();
    ...
    jQuery('#bt_voltar').click(function(){
        ...
        jQuery('.div_acao_cadastrar').hide();
        jQuery('.resultado_pesquisa').fadeIn();
        jQuery('#div_msg_cadastro').fadeIn();
        jQuery('#div_msg_pesquisar').hide();
        jQuery('.div_acao_pesquisar').show();
                    ...
                    try{
                        ...
                        if(resultado.error){
                            ...
                            jQuery(tr).effect('highlight', {}, 1000, function() {
                            	...
                            	jQuery('.tdc').removeClass('tdc');
                                jQuery('.tde').removeClass('tde');	
