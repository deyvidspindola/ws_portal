jQuery(document).ready(function() {
   ...
   jQuery("#campo_data_solicitacao").hide();
    ...
    /**
     * replicar a data de solicitação para todos os contratos
     */
    ...
    jQuery('body').on('click', '.rescisao-finalizar', function() {
        ...
        if (parseFloat(totalRescisao.val()) <= 0) {
            addError(totalRescisao, 'Não é possível gerar rescisão com valores negativos.');
            return;
        }
        ...
        // Busca os valores das multas de locação
        var multasLocacao = [];
