...
var pode_avaliar = "<?php echo $this->view->parametros->cadastro['pode_avalidar'] ?>";
...
<script type="text/javascript" src="modulos/web/js/fin_credito_futuro_pendentes.js"></script>
...
<div class="modulo_titulo">Crédito Futuro Pendentes</div>
