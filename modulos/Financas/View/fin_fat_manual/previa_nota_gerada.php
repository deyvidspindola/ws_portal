				...
				<div class="bloco_conteudo">
					...
					<div class="listagem">
						<table>
							...
							<tbody>
								<tr>
									<td>Número:</td><td><?=$nota['nflno_numero']?></td>
								</tr>
								<tr class="par">
									<td>Série:</td><td><?=$nota['nflserie']?></td>
								</tr>
								<tr>
								...
								<tr>
									<td>Emissão:</td><td><?=$nota['nfldt_emissao']?></td>
								</tr>
								<tr class="par">
								...
								<tr class="par">
									<td>Informações Complementares na NF-e:</td><td><?=$nota['infCompNfe'];?></td>
								</tr>																	
							</tbody>
						</table>
					</div>	 
