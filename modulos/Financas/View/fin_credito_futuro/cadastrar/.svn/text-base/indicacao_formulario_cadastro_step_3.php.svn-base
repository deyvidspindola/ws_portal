<div class="campo menor">
    <label for="contrato_indicado">Contrato Indicado</label>
    <input type="text" class="campo" value="<?php echo trim($_SESSION['credito_futuro']['step_2']['cfoconnum_indicado']); ?>" readonly />
</div>
...
<?php
$obrigacaofinanceiraDesconto = isset($this->view->parametros->cadastro['cfoobroid_desconto']) && trim($this->view->parametros->cadastro['cfoobroid_desconto']) != '' ? trim($this->view->parametros->cadastro['cfoobroid_desconto']) : $this->view->parametros->parametracaoCreditoFuturo->cfeaobroid_campanha; 
?>
<div class="campo maior">
