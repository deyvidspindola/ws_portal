...
<div class="campo menor espaco_falso <?php echo isset($this->view->parametros->cadastro['cfoforma_aplicacao']) && $this->view->parametros->cadastro['cfoforma_aplicacao'] == '2' ? 'invisivel' : '' ?>"></div>
