...
<div class="bloco_conteudo">
    <div class="formulario">
        ...
        <div class="campo medio">
            <label id="lbl_cfooid" for="cfooid">Código de identificação (ID)</label>
            <input type="text" id="cfooid" maxlength="10"  value="<?php echo trim($this->view->parametros->cfooid) ?>" name="cfooid" class="campo" />
        </div>     

        <div class="campo menor"></div>

        <div class="campo medio">
            <label id="lbl_cfoconnum_indicado" for="contrato">Contrato Indicado</label>
            <input type="text" id="cfoconnum_indicado" maxlength="10" name="cfoconnum_indicado" value="<?php echo trim($this->view->parametros->cfoconnum_indicado) ?>" class="campo" />
        </div>     
        ...
        <div class="campo medio">
            <label id="lbl_cfocfcpoid" for="campanha_promocional">Campanha promocional (ID)</label>
            <input type="text" id="cfocfcpoid" name="cfocfcpoid" maxlength="10" value="<?php echo trim($this->view->parametros->cfocfcpoid) ?>" class="campo" />
        </div>   
        ...
        <div class="campo maior">
            ...
            <select id="cfostatus" name="cfostatus">
                <option <?php echo ($this->view->parametros->cfostatus == '') ? 'selected="selected"' : '' ?> value="">SELECIONE</option>
                <option <?php echo ($this->view->parametros->cfostatus == '1') ? 'selected="selected"' : '' ?> value="1">Aprovado</option>
                <option <?php echo ($this->view->parametros->cfostatus == '2') ? 'selected="selected"' : '' ?> value="2">Concluído</option>
                <option <?php echo ($this->view->parametros->cfostatus == '3') ? 'selected="selected"' : '' ?> value="3">Pendente</option>
        ...
        <fieldset class="medio">
            <legend id="lgd_registros_apenas">Apresenta apenas os registros</legend>
            <input type="checkbox" id="registros_apenas_1" name="registros_apenas[]" <?php echo is_array($this->view->parametros->registros_apenas) && in_array('1', $this->view->parametros->registros_apenas) ? 'checked="checked"' : '' ?> value="1" />
            <label id="lbl_registros_apenas_1" for="registros_apenas_1">Excluídos</label>
            <input type="checkbox" id="registros_apenas_2" name="registros_apenas[]" <?php echo is_array($this->view->parametros->registros_apenas) && in_array('2', $this->view->parametros->registros_apenas) ? 'checked="checked"' : '' ?> value="2" />
            <label id="lbl_registros_apenas_2" for="registros_apenas_2">Encerrados</label>
        </fieldset>
        ...
        <fieldset class="maior">
            <legend id="lgd_cfosaldo" >Saldo pendente</legend>
            <input type="radio" id="cfosaldo_1" name="cfosaldo" value="1" <?php echo trim($this->view->parametros->cfosaldo) != '' && $this->view->parametros->cfosaldo == '1' ? 'checked="checked"' : ''  ?> />
            <label id="lbl_cfosaldo_1" for="cfosaldo_1">Sim</label>
            <input type="radio" id="cfosaldo_2" name="cfosaldo" value="2" <?php echo trim($this->view->parametros->cfosaldo) != '' && $this->view->parametros->cfosaldo == '2' ? 'checked="checked"' : '' ?> />
            <label id="lbl_cfosaldo_2" for="cfosaldo_2">Não</label>
            <input type="radio" id="cfosaldo_3" name="cfosaldo" value="3" <?php echo trim($this->view->parametros->cfosaldo) != '' && $this->view->parametros->cfosaldo == '3' ? 'checked="checked"' : ($this->view->parametros->cfosaldo != '2' && $this->view->parametros->cfosaldo != '1') ? 'checked="checked"' : '' ?> />
            <label id="lbl_cfosaldo_3" for="cfosaldo_3">Todos</label>
        </fieldset>
        ...
        <div class="campo maior">
            <div class="msg_aviso inativo">
                Mantenha a tecla CTRL ou SHIFT pressionada para selecionar vários motivos de crédito.
            </div>
        </div>
...
<div class="bloco_acoes">
    ...
    <?php if ($this->view->parametros->verificarCadastroEmailAprovacao) : ?>
