...
<head>    
    ...
    <script language="Javascript" type="text/javascript" src="modulos/web/js/fin_controle_fiscal_instalacoes.js"></script> 
...
<form name="form" id="form" method="POST" action="">
    ...
    <ul class="bloco_opcoes">
        ...
        <li class="ativo"><a href="fin_controle_fiscal_remessas.php?acao=instalacoes">Instalações</a></li>
        <li><a href="fin_controle_fiscal_remessas.php?acao=retiradas">Retiradas</a></li>
        <li><a href="fin_controle_fiscal_remessas.php?acao=equipamentoMovel">Equipamento Móvel</a></li>
    </ul>
    <div class="bloco_titulo">Ordem de Serviço Instalações</div>
