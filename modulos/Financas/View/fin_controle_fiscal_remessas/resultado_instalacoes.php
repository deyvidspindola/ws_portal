...
<script>
    function gerarRelatorio() {
        ...
        document.form.action = "modulos/Financas/View/fin_controle_fiscal_remessas/resultado_instalacoes_csv.php";
        ...
        <table>
            ...
            <tbody>
                <?php
                    ...
                    while ($row = pg_fetch_object($this->view->instalacoes)) {$x++;
