...
<div class="bloco_conteudo">
        <div class="formulario">
            ...
            <div class="campo data hidden" id="campo_data_solicitacao">
                <label for="data_soli">Replicar Data</label>
                <input type="text" class="campo" id="data_solicitacao" name="data_solicitacao" value="" />
            </div>
